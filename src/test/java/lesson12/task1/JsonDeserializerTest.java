...
public class JsonDeserializerTest {
    ...
    private final String ROOM_PATH = "src\\main\\java\\lesson12\\room.json";
    private final String FLAT_PATH = "src\\main\\java\\lesson12\\flat.json";
    private final String HOUSE_PATH = "src\\main\\java\\lesson12\\house.json";
